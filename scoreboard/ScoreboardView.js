export default class ScoreboardView {
	constructor(root, playerOneName, playerTwoName, playerThreeName, playerFourName, playerFiveName, playerSixName, onControlButtonClick) {
		...
		this.root.innerHTML = `
			<div class="scoreboard">
				...
				<div class="scoreboard__name scoreboard__name--six">${playerSixName}</div>
				<div class="scoreboard__score" data-for-player="six">0</div>
				<div class="scoreboard__controls" data-for-player="six">
				<button class="scoreboard__control-button">-</button>
				<button class="scoreboard__control-button">+</button>
			</div>
	...
	update(playerOneScore, playerTwoScore, playerThreeScore, playerFourScore, playerFiveScore, playerSixScore) {
		...
		this.root.querySelector(".scoreboard__score[data-for-player='six']").textContent = playerSixScore;
	}
}
